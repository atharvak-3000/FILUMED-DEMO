...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[100vh] flex flex-col items-center justify-center text-center overflow-hidden bg-black pt-[120px] pb-[80px] px-6 md:px-12">
      {/* Background Layers */}
      ...
      <motion.div
        ...
        className="absolute left-6 md:left-12 top-[120px] w-[3px] bg-red origin-top z-10"
      />
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center justify-center mt-16 md:mt-8">
        ...
        <motion.div
          ...
          className="font-mono text-[11px] text-red uppercase tracking-[5px] mb-8 select-none"
        >
        ...
        <h1 
          ...
          style={{ fontSize: 'clamp(40px, 5vw, 76px)', lineHeight: '1.05' }}
        >
        ...
        <motion.p
          ...
          className="font-body text-[18px] uppercase tracking-[2px] text-white/55 text-center max-w-[560px] mx-auto mb-[52px] leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="flex flex-row items-center justify-center gap-4 w-full max-w-[480px] sm:max-w-[540px] px-4"
        >
          {/* Left Button — VIEW OUR WORK */}
          <Link
            href="/work"
            className="btn-sweep flex-1 text-center py-[12px] px-4 sm:px-11 bg-red text-white font-mono text-[12px] uppercase tracking-[3px] border-2 border-red hover:border-white transition-colors duration-300 rounded-none z-10 select-none"
          >
            VIEW OUR WORK &rarr;
          </Link>
          ...
          <Link
            href="#services"
            className="btn-sweep-red flex-1 text-center py-[12px] px-4 sm:px-11 bg-transparent text-white font-mono text-[12px] uppercase tracking-[3px] border-none hover:border-red transition-colors duration-300 rounded-none z-10 select-none"
          >
            EXPLORE SERVICES
          </Link>
        </motion.div>
